...
public class ProcesadorFicheroXML
{
	...
	private static void leerPrediccionDia(Element subseccion, ListaDia dias)
	{
		try
		{
			parser.datos.Dia dia = new parser.datos.Dia();
...
//			System.out.println(fechaDia);
	 ...
	 * @param dia
	 */
	private static void mapProbPrecipitacion(Element atDia, parser.datos.Dia dia)
	{
		try
		{
...
//			array[0] = atDia.getAttributeValue(CodeNames.DESCRIPCION_ATR);
	 ...
	 * @param dia
	 */
	private static void mapRachaMax(Element atDia, parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapTemperatura(Element atDia, parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapSensacionTermica(Element atDia, parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapHumedadRelativa(Element atDia, parser.datos.Dia dia)
	{
		try
		{
	 ...
	 * @param dia
	 */
	private static void mapUVMax(Element atDia, parser.datos.Dia dia)
	{
		try
		{
