...
@Entity
@Table(name = "temperatura_intervalos", schema = "", catalog = "stw_weather")
public class TemperaturaIntervalosEntity
{
	...
	public void setTemperatura(TemperaturaEntity temperaturaEntity)
	{
		this.temperatura = temperaturaEntity;
	}
	...
	public boolean equals(Object o)
	{
		...
		TemperaturaIntervalosEntity that = (TemperaturaIntervalosEntity) o;
