...
@Entity
@Table(name = "sensacion_termica_intervalos", schema = "",
		catalog = "stw_weather")
public class SensacionTermicaIntervalosEntity
{
	@Id
	@Column(name = "codigo")
	private int codigo;
	...
	public void setSensacionTermica(SensacionTermicaEntity sensacionTermicaEntity)
	{
		this.sensacionTermica = sensacionTermicaEntity;
	}
	...
	public boolean equals(Object o)
	{
		...
		SensacionTermicaIntervalosEntity that = (SensacionTermicaIntervalosEntity) o;
