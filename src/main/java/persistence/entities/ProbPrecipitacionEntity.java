...
/**
 * Created by alex1_000 on 01/04/2015.
 */
@Entity
@Table(name = "prob_precipitacion", schema = "", catalog = "stw_weather")
public class ProbPrecipitacionEntity
{
	@Id
	@Column(name = "codigo")
	private int codigo;
	...
	public boolean equals(Object o)
	{
		...
		ProbPrecipitacionEntity that = (ProbPrecipitacionEntity) o;
